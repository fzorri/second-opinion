# WizardLM 8x22 from lepton.ai
# https://www.lepton.ai/playground/chat/wizardlm-2-8x22b
...
from config import Lepton_WizardLM_8x22_CFG
from datetime import datetime
from tools import Tools
from rich.console import Console
from rich.markdown import Markdown

class Lepton_WizardLM_8x22_LLM(LLMBase):
    def __init__(self):
        config = Lepton_WizardLM_8x22_CFG
    ...
    def initialize_client(self):
        return openai.OpenAI(api_key=self.api_key,base_url="https://wizardlm-2-8x22b.lepton.run/api/v1/")        
